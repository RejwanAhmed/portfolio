  ...
  <body>
    ...
    <div class="projects" id="projects">
      ...
      <div class="container projects_container">
                ...
                <div class="modal_body">
                  ...
                  <div style="margin-top: 2rem">
                    <!-- <a type="button" class="btn" href="#" target="_blank"
                      >Github</a
                    > -->
                    <a type="button" class="btn" href="https://bfaresultsystem.rejwancse10.com/admin_panel/" target="_blank"
                      >Live</a
                    >
                  </div>
                </div>
        ...
        <!-- Start: Journal Management System -->
        <article>
          <div class="project_image card_btn">
            <img src="image/jms-1.png" alt="project 3" />
          </div>
          ...
          <div class="modal">
            <div class="modal_wrapper">
              <div class="modal_content">
                <div class="modal_head">
                  <h3 class="heading">Journal Management System of JKKNIU</h3>
                  <small> <strong>Duration:</strong> 2021-2023(Aug-Apr)</small>
                </div>
                <!-- Carousel: Start -->
                <div class="carousel-container">
                  <div class="images6 fade">
                     <img src="image/jms-1.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-2.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-3.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-4.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-5.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-6.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-7.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-8.png">
                     </div>
                     <div class="images6 fade">
                        <img src="image/jms-9.png">
                     </div>
                     <!-- Previous and Next Buttons -->
                     <a class="previous" onclick="plusSlides6(-1)">❮</a>
                     <a class="next" onclick="plusSlides6(1)">❯</a>
                </div>
                 
                 <!-- Navigation Dots-->
                <div style="text-align:center">
                  <span class="navigation-dot6" onclick="currentSlide6(1)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(2)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(3)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(4)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(5)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(6)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(7)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(8)"></span>
                  <span class="navigation-dot6" onclick="currentSlide6(9)"></span>
                </div>
                 <!-- Carousel : End -->
                <div class="modal_body">
                  <p style = "font-size: 15px">
                    This is a system managing Nazrul Journals of JKKNIU. It has 4 panels. Here author can submit papers. Reviewer can review it. Associative editor assigns reviewer for each paper. Finally main editor decides whether to accept the paper or reject it. He can also publish a paper if accepted.
                    <br>
                    <small><b>Technologies: HTML, CSS, Bootstrap, Javascript, PHP, SQL, MySQL</b></small>
                  </p>
                  <div style="margin-top: 2rem">
                    <a
                      type="button"
                      class="btn"
                      href="https://github.com/RejwanAhmed/journal_management_system"
                      target="_blank"
                      >Github</a
                    >
                    <a
                      type="button"
                      class="btn"
                      href="https://nazruljournal.rejwancse10.com/"
                      target="_blank"
                      >Live</a
                    >
                  </div>
